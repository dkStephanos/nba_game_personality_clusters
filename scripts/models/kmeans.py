...
def get_samples_closest_to_centroid(
    ...
    for i, center in enumerate(cluster_centers):
        ...
        distances = euclidean_distances(cluster_points[feature_cols], [center[:len(feature_cols)]])

        # Add distances to the DataFrame
        cluster_points = cluster_points.copy()
        cluster_points['distance_to_centroid'] = distances.flatten()

        # Get the indices of the closest points
        closest_indices = distances.flatten().argsort()[:num_samples]
